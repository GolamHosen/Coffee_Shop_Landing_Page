...
const About = () => {
  ...
  const values = [
    ...
    },
    {
      ...
      description:
        "Building connections and creating a welcoming space for everyone.",
      icon: (
        <svg
          className="w-8 h-8"
          fill="none"
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="text-center mb-16 animate-fade-in">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto leading-relaxed">
            Where passion meets perfection in every cup. Crafting exceptional
          ...
          <div className="space-y-6 text-gray-700 dark:text-gray-300 animate-slide-up">
            <div className="space-y-4">
              <p className="text-lg md:text-xl leading-relaxed">
                ...
                , where passion meets perfection in every cup. Founded in 2015,
                we've been serving our community with handcrafted coffee made
                from the finest beans sourced from sustainable farms around the
                world.
              </p>
              <p className="text-lg leading-relaxed">
                Our journey began with a simple belief: that great coffee should
                be accessible to everyone. We roast our beans in-house daily,
                ensuring that every sip delivers the rich, complex flavors our
                customers have come to love.
              </p>
              <p className="text-lg leading-relaxed">
                Beyond coffee, we're committed to creating a warm, welcoming
                space where friends gather, ideas flow, and memories are made.
                Whether you're starting your day with an espresso or winding
                down with a cold brew, we're here to make every moment special.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-r from-amber-600 to-orange-600 dark:from-amber-700 dark:to-orange-700 rounded-2xl p-8 md:p-12 text-white shadow-2xl relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-lg md:text-xl leading-relaxed max-w-3xl">
              ...
              together, while supporting sustainable farming practices and
              building a stronger community one cup at a time.
            </p>
          </div>
        </div>
      </div>
